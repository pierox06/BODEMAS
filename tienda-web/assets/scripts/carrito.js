...
(function($){
	...
	app.masVendidos = function(){
		var productos = [
			...
			{
				id : 3,
				name : 'Mantequilla del Campo',
				img : 'assets/img/mantequilla.jpg',
				price : 20.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 15
			},
			{
				id : 4,
				name : 'La Calera Huevos Clásicos Pardos',
				img : 'assets/img/huevos.png',
				price : 11.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 13
			},
			...
			{
				id : 7,
				name : 'Queso Fresco Prensado',
				img : 'assets/img/Queso.jpg',
				price : 30.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 9
			},
			{
				id : 8,
				name : 'Pan Artesanal con Semillas de Ajonjoli',
				img : 'assets/img/Biopan.jpg',
				price : 7.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 15
			},
			{
				id : 9,
				name : 'Yogur la Molina',
				img : 'assets/img/Yogur.jpg',
				price : 15.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 10
			}
		...
		for(var i = 0; i < productos.length; i++){
			...
			if(productos[i].stock > 0){
				...
				contenido+= '			<h3>'+productos[i].name+' <span class="price">S./ '+productos[i].price+' </span></h3>'
